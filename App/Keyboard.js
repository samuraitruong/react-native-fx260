import {evalExpr, clearCommand, shiftOn, tenPowX,logaritX, saveMemory} from './Services/MathEngine'
...
export default  keyboard = [
    ...
    [{normal:'0', shift:'RND'},{normal: {display:'.', expr: '.'}, shift: 'RND#'},{normal:'EXP', shift: 'π'},{normal: {display:  '=', cmd: evalExpr}, shift: '%'},{normal:{ display:'M+', cmd: saveMemory}, shift: 'M-'} ]
