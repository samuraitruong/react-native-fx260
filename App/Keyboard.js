import {evalExpr, clearCommand} from './Services/MathEngine'

export default  keyboard = [
    [{normal:'', shift:'shift'},{normal:'MODE', shift: null},{normal:{display:'x²', lcdDisplay:'²',expr: '^2'}, shift: '√'},{normal:{display: 'log', lcdDisplay: 'log(', expr:'log('}, shift: '10^x'},{normal:{display: 'ln', lcdDisplay: 'ln(', expr:'ln('}, shift: 'e^x'},{normal:'On', shift: 'On'} ],
